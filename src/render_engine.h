...
struct RenderFrameParams {
    ...
    bool   cursorLocked;        // Inspect mode active: replace the arrow with a crosshair reticle
    bool   warpCursor;          // false = do NOT SetCursorPos the OS cursor (1x Inspect: free crosshair)
};
