...
TEST_CASE("telemetry line format matches the header contract") {
    // Header has 16 comma-separated columns and a trailing newline (the written-transform
    ...
    s.wLevel = 13.995; s.wTxX = -24837; s.wTxY = -11020; s.wHook = 4242;
    ...
    CHECK(line.find(",1921,1080,1,13.995000,-24837,-11020,4242\n") != std::string::npos);
}
