...
TEST_CASE("telemetry line format matches the header contract") {
    // Header has 20 comma-separated columns and a trailing newline (the written-transform
    ...
    s.wLevel = 13.995; s.wTxX = -24837; s.wTxY = -11020; s.wHook = 4242; s.lagPx = 7.25; s.spriteX = 900; s.spriteY = 500; s.spriteOn = 1; s.hideFails = 3;
    ...
    CHECK(line.find(",1921,1080,1,13.995000,-24837,-11020,4242,7.25,900,500,1,3\n") != std::string::npos);
}
