export const sections = [
  ...
  { id:'display', label:'Display', icon:'display', desc:'Image quality of the magnified view.', rows: [
    { key:'model', type:'select', label:'Magnifier model',
      ...
      def:'hybrid' },
    { key:'autoIgnoreApps', type:'applist', label:'Ignore these apps when switching',
      desc:'Auto keeps the engine it is already using while one of these is in front. Stops brief overlays causing two swaps in a few seconds.',
      def:'', showIf:{ key:'model', eq:'hybrid' } },
