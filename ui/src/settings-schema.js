export const sections = [
  ...
  { id:'display', label:'Display', icon:'display', desc:'Image quality of the magnified view.', rows: [
    { key:'model', type:'select', label:'Magnifier model',
      ...
      def:'hybrid' },
    { key:'hybridSwitch', type:'select', label:'Auto switch',
      desc:'When Auto changes engine: on zoom-out only (never disturbs the current zoom) or instantly when the focused app changes (keeps your zoom level across the swap).',
      options:['0','1'], optionLabels:{ '0':'On zoom out', '1':'Instantly' },
      def:'0', showIf:{ key:'model', eq:'hybrid' } },
