export const sections = [
  ...
  { id:'cursor', label:'Cursor', icon:'cursor', desc:'Pointer movement and visibility while zoomed.', rows: [
    ...
    { key:'__cursorLock', type:'keybind', label:'Crosshair cursor', desc:'Toggle a crosshair cursor system-wide, at any zoom. Press to set, right-click to clear.', vkKey:'cursorLockVk' },
  ]},
